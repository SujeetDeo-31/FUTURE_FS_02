        ...
        return (
          <GlassCard>
            <div className='p-8 space-y-8'>
              ...
              <div className='text-center py-10 text-muted-foreground'>Security settings coming soon.</div>
            </div>
          </GlassCard>
        );
      case 'Notifications':
        ...
        return (
          <GlassCard>
            <div className='p-8 space-y-8'>
              ...
              <div className='text-center py-10 text-muted-foreground'>Billing management coming soon.</div>
            </div>
          </GlassCard>
        );
      default:
